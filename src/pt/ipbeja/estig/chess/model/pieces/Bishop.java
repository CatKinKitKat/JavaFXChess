/**
 * Gonçalo Candeias Amaro 17440 - Bishop
 */
...
public class Bishop extends Pieces {
     ...
     */
    public Bishop(Model model, Position position, Model.PieceColour color) {
        this.model = model;
        this.color = color;
    ...
    public ImageView getImage() {
        ...
        if (color == Model.PieceColour.WHITE) {
            return new ImageView(
                    new Image("resources/WhiteBishop.png", 80, 80, false, false)
            );
        } else {
            return new ImageView(
                    new Image("resources/BlackBishop.png", 80, 80, false, false)
            );
        }
